...
import { ANIME_COVER_ASPECT_RATIO } from '@/features/anime/Anime.constants.ts';
...
/** Mirrors MangaGridCard.tsx, minus the continue-reading-button slot (see Anime.types.ts). */
export const AnimeGridCard = memo(
    ({
        anime,
        longPressBind,
        popupState,
        ...
        return (
            ...
            >
                ...
                >
                    <Card
                        sx={{
                            // force standard aspect ratio of anime covers
                            aspectRatio: ANIME_COVER_ASPECT_RATIO,
                            display: 'flex',
                        }}
                    >
                        <CardActionArea
                        ...
                        >
                            <SpinnerImage
                                alt={title}
                                src={Animes.getThumbnailUrl(anime)}
                                imgStyle={
