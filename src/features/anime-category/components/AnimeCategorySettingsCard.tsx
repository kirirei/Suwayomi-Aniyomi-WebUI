...
import type { AnimeCategoryIdInfo, AnimeCategoryNameInfo } from '@/features/anime-category/AnimeCategory.types.ts';
import { Confirmation } from '@/base/AppAwaitableComponent.ts';
import { makeToast } from '@/base/utils/Toast.ts';
import { getErrorMessage } from '@/lib/HelperFunctions.ts';

/** Mirrors CategorySettingsCard.tsx, backed by the anime category mutations. */
export const AnimeCategorySettingsCard = ({
    category,
    onEdit,
}: {
    category: AnimeCategoryIdInfo & AnimeCategoryNameInfo;
    onEdit: () => void;
}) => {
    const { t } = useLingui();
